...
extension User {
    public static func ariyoshi() -> User {
        User(id: "ariyoshihiroyuki", name: "有吉弘行", introduction: "穏やかに。。。", birthDay: nil, imageName: "ariyoshi")
    }
    public static func matsumoto() -> User {
        User(id: "matsu_bouzu", name: "松本人志", introduction: "所属事務所：吉本興業 コンビ名：ダウンタウン 血液型：Ｂ型", birthDay: nil, imageName: "matsumoto")
    }
    public static func nobu() -> User {
        User(id: "NOBUCHIDORI", name: "千鳥ノブ", introduction: "千鳥ノブです。大漫才師です。サインの横にたまに「夢ひとつ」と添えます。", birthDay: nil, imageName: "nobu")
    }
    public static func eiko() -> User {
        User(id: "kano9x", name: "狩野英孝", introduction: "千鳥ノブです。大漫才師です。サインの横にたまに「夢ひとつ」と添えます。", birthDay: nil, imageName: "eiko")
    }
